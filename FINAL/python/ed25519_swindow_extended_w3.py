# Sliding Window, window size fix to 3
...
class point:
	...
	def __mul__(self, M: int) -> 'point':
		""" Sliding window with w = 3 method """
		r = point(number(0), number(1))  # the zero point
		M_in_bin = "{:0255b}".format(M)
		precal_10 = self+self
		precal_100 = precal_10+precal_10
		precal_101 = precal_100+self
		precal_110 = precal_101+self
		precal_111 = precal_110+self
		i = 0
		flag = 0
		while (i < 255):
			if(flag == 0):
			...
			if(M_in_bin[i] == "0"):
				...
				if(M_in_bin[i:i+3] == "100"):
					r = r + precal_100
					flag = 1
					i = i + 3
				elif(M_in_bin[i:i+3] == "101"):
					r = r + precal_101
					flag = 1
					i = i + 3
				elif(M_in_bin[i:i+3] == "110"):
					r = r + precal_110
					flag = 1
					i = i + 3
				elif(M_in_bin[i:i+3] == "111"):
					r = r + precal_111
					flag = 1
					i = i + 3
				else:
