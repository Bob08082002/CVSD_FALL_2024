...
window_size = 2  # when window_size = 1 ==> double and add
...
if __name__ == "__main__":
	...
	print("approximate cycle: ", (count_point_double*10 + count_point_addition*9) + count_div_mul)  # ignore idle, read, output, pre-cal(有含算lut的add), div-mul *X, *Y
